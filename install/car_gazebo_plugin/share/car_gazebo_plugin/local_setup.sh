...
: ${AMENT_CURRENT_PREFIX:="/home/ros2/ros2_ws2/install/car_gazebo_plugin"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/car_gazebo_plugin/environment/library_path.sh"
